...
- Staging deployment: Pages deployment `39ab34be` and Worker version `7a904eea-32ce-421d-aa28-3e7279cf6cf8` are live. The 89.84 KiB Worker accepts only the protected Pages origin; the detached custom hostname is excluded. Stable and generated Pages site/API routes return 302 anonymously, and the direct Worker returns 403.
- Remote quality evidence: GitHub Actions run `30665075085` passed on branch head `dff5dc7`.
